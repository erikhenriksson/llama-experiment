...
def precompute_rope_params(
    head_dim, theta_base=10000, context_length=4096, freq_config=None
):
...
class MultiHeadAttention(nn.Module):
    def __init__(
        self, d_in, d_out, context_length, num_heads, dtype=None
        ...
        self.out_proj = nn.Linear(
            d_out, d_out, bias=False, dtype=dtype
...
class TransformerBlock(nn.Module):
    def __init__(self, cfg: LlamaConfig) -> None:
        ...
        self.att = GroupedQueryAttention(  # MultiHeadAttention(
            ...
            rope_config=asdict(cfg.rope_freq),
            dtype=cfg.dtype,
        )
